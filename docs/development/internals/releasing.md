...
2. Refresh `README.md`, `docs/index.html`, `AGENTS.md`, and any affected
   `docs/development/**/*.md` pages so the published docs and repo snapshots
   describe the current shipped state instead of the previous release. When
   the static landing page has a "Latest" or release-highlights section,
   update that summary too, and keep any README "current release" links aligned
   with the new tag.
