...
Commands:
  ...
  hybridclaw agent install <file.claw|official:<agent-id-or-dir>|github:owner/repo/<agent-id-or-dir>> [--id <id>] [--force] [--skip-externals] [--yes]
...
Notes:
  ...
  - \`install official:<agent-id-or-dir>\` downloads a packaged agent from \`HybridAIOne/claws\` on GitHub before installing it.
  - \`install github:owner/repo/<agent-id-or-dir>\` resolves the packaged agent from a GitHub claws repo; use \`github:owner/repo/<ref>/<agent-id-or-dir>\` to pin a ref.
